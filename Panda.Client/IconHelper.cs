    ...
    public static class IconHelper
    {
        ...
        public static ImageSource IconFromFilePath(string filePath)
        {
            ...
            {              
                ...
                var hImgSmall = Win32.SHGetFileInfo(filePath, 0, ref shinfo, (uint)Marshal.SizeOf(shinfo), Win32.SHGFI_ICON | Win32.SHGFI_LARGEICON); // todo: handle big/small requests
            ...
            {   
                Icon icon = new Icon("unknownfile32x32.ico");
                var bmp = icon.ToBitmap();
                var img = Imaging.CreateBitmapSourceFromHBitmap(bmp.GetHbitmap(), IntPtr.Zero, Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions());
                img.Freeze();
